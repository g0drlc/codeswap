...
export const defaultTokens: Record<BlockchainName, Token[]> = {
  ...
  [BLOCKCHAIN_NAME.ASTAR_EVM]: [
    {
      ...nativeTokensList[BLOCKCHAIN_NAME.ASTAR_EVM],
      ...defaultTokenParams,
    } as Token,
    {
      ...wrappedNativeTokensList[BLOCKCHAIN_NAME.ASTAR_EVM],
      ...defaultTokenParams,
    } as Token,
    {
  ...
  [BLOCKCHAIN_NAME.ICP]: [
    {
      ...nativeTokensList[BLOCKCHAIN_NAME.ICP],
      ...defaultTokenParams,
    } as Token,
  ],
  [BLOCKCHAIN_NAME.PULSECHAIN]: [
    {
      ...nativeTokensList[BLOCKCHAIN_NAME.PULSECHAIN],
      ...defaultTokenParams,
    } as Token,
  ],
  [BLOCKCHAIN_NAME.LINEA]: [
    {
      ...nativeTokensList[BLOCKCHAIN_NAME.LINEA],
      ...defaultTokenParams,
    } as Token,
  ],
  [BLOCKCHAIN_NAME.BASE]: [
    {
      ...nativeTokensList[BLOCKCHAIN_NAME.BASE],
      ...defaultTokenParams,
    } as Token,
  ],
  [BLOCKCHAIN_NAME.MANTLE]: [
    {
      ...nativeTokensList[BLOCKCHAIN_NAME.MANTLE],
      ...defaultTokenParams,
    } as Token,
  ],
  [BLOCKCHAIN_NAME.HORIZEN_EON]: [
    {
      ...nativeTokensList[BLOCKCHAIN_NAME.HORIZEN_EON],
      ...defaultTokenParams,
    } as Token,
  ],
  ...
  [BLOCKCHAIN_NAME.MERLIN]: [
    {
      ...nativeTokensList[BLOCKCHAIN_NAME.MERLIN],
      ...defaultTokenParams,
    } as Token,
  ],
  [BLOCKCHAIN_NAME.KROMA]: [
    {
      ...nativeTokensList[BLOCKCHAIN_NAME.KROMA],
      ...defaultTokenParams,
    } as Token,
  ],
  [BLOCKCHAIN_NAME.ROOTSTOCK]: [
    {
      ...nativeTokensList[BLOCKCHAIN_NAME.ROOTSTOCK],
      ...defaultTokenParams,
    } as Token,
  ],
  [BLOCKCHAIN_NAME.MODE]: [
    {
      ...nativeTokensList[BLOCKCHAIN_NAME.MODE],
      ...defaultTokenParams,
    } as Token,
  ],
  [BLOCKCHAIN_NAME.ZK_FAIR]: [
    {
      ...nativeTokensList[BLOCKCHAIN_NAME.ZK_FAIR],
      ...defaultTokenParams,
    } as Token,
  ],
  [BLOCKCHAIN_NAME.ZK_LINK]: [
    {
      ...nativeTokensList[BLOCKCHAIN_NAME.ZK_LINK],
      ...defaultTokenParams,
    } as Token,
  ],
  [BLOCKCHAIN_NAME.XLAYER]: [
    {
      ...nativeTokensList[BLOCKCHAIN_NAME.XLAYER],
      ...defaultTokenParams,
    } as Token,
  ],
  ...
  [BLOCKCHAIN_NAME.SEI]: [
    {
      ...nativeTokensList[BLOCKCHAIN_NAME.SEI],
      ...defaultTokenParams,
    } as Token,
  ],
  [BLOCKCHAIN_NAME.CORE]: [
    {
      ...nativeTokensList[BLOCKCHAIN_NAME.CORE],
      ...defaultTokenParams,
    } as Token,
  ],
  [BLOCKCHAIN_NAME.BAHAMUT]: [
    {
      ...nativeTokensList[BLOCKCHAIN_NAME.BAHAMUT],
      ...defaultTokenParams,
    } as Token,
  ],
  [BLOCKCHAIN_NAME.GRAVITY]: [
    {
      ...nativeTokensList[BLOCKCHAIN_NAME.GRAVITY],
      ...defaultTokenParams,
    } as Token,
  ],
};
