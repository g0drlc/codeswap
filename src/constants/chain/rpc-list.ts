...
export const rpcList: Record<EvmBlockchainName, string[]> &
  ...
  [BLOCKCHAIN_NAME.ETHEREUM]: [
    'https://lb.drpc.org/ogrpc?network=ethereum&dkey=AoribOsTqURarSE5LBVCZ3Vag6w-dnIR7495hlDYfw4q',
    'wss://ethereum-rpc.publicnode.com',
    'https://eth.llamarpc.com',
    'https://rpc.ankr.com/eth'
  ],
  [BLOCKCHAIN_NAME.BINANCE_SMART_CHAIN]: [
    'https://lb.drpc.org/ogrpc?network=bsc&dkey=AoribOsTqURarSE5LBVCZ3Vag6w-dnIR7495hlDYfw4q',
  ...
  [BLOCKCHAIN_NAME.POLYGON]: [
    'https://lb.drpc.org/ogrpc?network=polygon&dkey=AoribOsTqURarSE5LBVCZ3Vag6w-dnIR7495hlDYfw4q',
