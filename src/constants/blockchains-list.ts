...
import { BlockchainTags } from "@/models/BlockchainFilters";
...
const notEvmChangeNowBlockchainsTagsList: Record<
...
const notEvmChangeNowFormattedBlockchainsList = Object.values(
  notEvmChangeNowBlockchainsList
).map((blockchain) => ({
  name: blockchain,
  rank: setRankToNonEvmBlockchain(blockchain),
  tags: [
    ...notEvmChangeNowBlockchainsTagsList[blockchain],
...
export const blockchainsList: RankedBlockchain[] = [
  ...
  },
  {
    ...
    rank: 0.75,
    tags: [BlockchainTags.EVM, BlockchainTags.PROMO],
  },
  {
  ...
  },
  {
    ...
    rank: 0.4,
    tags: ["GLMR", BlockchainTags.EVM],
  },
  {
    name: BLOCKCHAIN_NAME.MOONRIVER,
    rank: 0.4,
    tags: ["MOVR", BlockchainTags.EVM],
  },
  ...
  { name: BLOCKCHAIN_NAME.KLAYTN, rank: 0.2, tags: [BlockchainTags.EVM] },
  {
    ...
    rank: 0.1,
    tags: ["ROSE", BlockchainTags.EVM],
  },
  {
    name: BLOCKCHAIN_NAME.OKE_X_CHAIN,
    rank: 0.1,
    tags: ["OKT", BlockchainTags.EVM],
  },
